...
//    model.addAttribute("statusTeam", admLeagueService.getLeagueStatusTable(lno).getLeagueStatusTeamList());
  ...
  @RequestMapping("/adm/getLeagueStatusTeamList")
  @ResponseBody
  public List<Map<String, Object>> getLeagueStatusTeamList(int leagueId) {
    return admLeagueService.getLeagueStatusTable(leagueId).getLeagueStatusTeamList();
  }
